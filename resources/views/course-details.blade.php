<x-app-layout>
    <div class="flex w-full justify-center h-96 bg-cover bg-center" style="background-image: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('{{ asset('images/banner.jpg') }}');">
